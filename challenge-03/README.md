...
*/
pessoa.nomeCompleto() // Olá! Meu nome é Gabriel Vargas!
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarPeso() // Eu peso 71.5Kg.
...
pessoa.apresentacao = function() {
  ...
  var metrosCaminhados = pessoa.idade === 1 ? "metro" : "metros"

  return "Olá, eu sou " + sexo + " " + pessoa.nome + " " + pessoa.sobrenome + 
  ", tenho " + pessoa.idade + " " + idadeAnos + ", " + pessoa.altura + ", meu peso é " + pessoa.peso + 
